...
export default function EventCard({ event, isFav, toggleFavorite, onSelect, formatDateCzech, lowestPrice }) {
  return (
    <div 
      onClick={onSelect} 
      className="bg-black border-2 border-black overflow-hidden flex flex-col group relative h-[280px] sm:h-[300px] cursor-pointer hover:border-[#E4664F] transition-colors"
    >
      {/* Tlačítko oblíbených */}
      <button 
